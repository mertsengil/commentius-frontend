...
>('businesses/create', async (payload, { rejectWithValue }) => {
...
>('businesses/update', async ({ id, data }, { rejectWithValue }) => {
...
export { bulkUpdateBusinesses };   // dışarı aktar


/* ---- Selectors ---- */
export const selectAllBusinesses = (state: RootState) => state.businesses.items
export const selectBusinessesStatus = (state: RootState) => state.businesses.status
export const selectBusinessesError = (state: RootState) => state.businesses.error
export const selectBusinessById =
    (id: number) =>
        (state: RootState): Business | undefined =>
            state.businesses.items.find(b => b.id === id)

export const selectEnqueueStatus = (state: RootState) => state.businesses.status
